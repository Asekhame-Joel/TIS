...
.hero { position: relative; height: 250px; overflow: hidden; padding: 27px 36px; color: #fff; background: {$hero}; }
...
.hero-copy { position: absolute; left: 36px; bottom: 32px; width: 470px; z-index: 3; }
...
.event-seal { position: absolute; right: 38px; bottom: 48px; width: 98px; height: 98px; padding-top: 22px; color: #fff; text-align: center; border: 1px solid {$accent}; border-radius: 49px; background: rgba(7,16,33,.34); z-index: 3; }
...
.event-seal strong { display: block; margin: 5px 0 4px; font-family: DejaVu Serif, serif; font-size: 18px; line-height: 1; }
...
.ticket-body { padding: 19px 36px 0; }
.identity { width: 100%; margin: 0 0 14px; border-collapse: collapse; border: 1px solid #ded8ca; border-left: 7px solid {$accent}; background: #fff; }
.identity td { padding: 13px 20px; vertical-align: middle; }
...
.details td { width: 50%; height: 62px; padding: 11px 18px; vertical-align: top; border: 1px solid #e1dccf; }
...
.admission-note { position: relative; margin-top: 12px; padding: 12px 20px 12px 58px; color: #27334a; border: 1px solid #e2d6b8; background: {$accentSoft}; }
.admission-icon { position: absolute; left: 17px; top: 12px; width: 27px; height: 27px; padding-top: 6px; color: #fff; text-align: center; border-radius: 15px; background: {$accentDark}; font-size: 11px; font-weight: 700; }
...
.benefits { margin: 10px 0; padding: 8px 14px; border: 1px solid #ded8ca; background: #fbfaf5; }
.benefits .label { margin-bottom: 5px; }
.benefits ul { margin: 0; padding: 0; list-style: none; }
.benefits li { display: inline-block; width: 48%; margin: 0 0 3px; color: #526077; font-size: 8px; }
