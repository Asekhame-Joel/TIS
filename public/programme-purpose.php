...
<head>
  ...
  <title>Purpose — Clarity of direction | The Intellectual Summit</title>
  <meta name="description" content="Guided sessions that help young people name what they actually want, instead of borrowing someone else's definition of success.">
  <meta name="theme-color" content="#1b2a4a">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="The Intellectual Summit">
  <meta property="og:title" content="Purpose — Clarity of direction | The Intellectual Summit">
  <meta property="og:description" content="Guided sessions that help young people name what they actually want, instead of borrowing someone else's definition of success.">
  <link rel="canonical" href="/programme-purpose">
...
<body>
  ...
  <main id="main">
    <section class="hero hero-page">
      <div class="container">
        <nav class="breadcrumb" aria-label="Breadcrumb"><a href="/">Home</a> <span aria-hidden="true">/</span> <span>Purpose</span></nav>
        <span class="eyebrow">Programme &middot; Purpose</span>
        <h1>Clarity of direction</h1>
        <p class="lead">Guided sessions that help young people name what they actually want, instead of borrowing someone else's definition of success.</p>
      </div>
    </section>
    ...
    <section class="section section-white">
      <div class="container split">
        <div class="reveal">
          ...
          <h2>Purpose: why it exists</h2>
          <p>Purpose is the first track at The Intellectual Summit because everything else depends on it. A young person who cannot say what they want will spend years working hard in a direction someone else chose for them.</p>
          <p>The Purpose track uses guided sessions and honest conversation rather than motivational speaking. Participants are asked to put words to their own ambition, examine where that ambition came from, and test whether it still holds when it is said out loud in a room of peers.</p><p>Sessions are structured, not open-ended. Each one moves from reflection, to articulation, to a written direction the participant can return to after the room empties.</p>
        </div>
        <div class="reveal reveal-delay-1">
          <div class="card">
            ...
            <h3>What you get</h3>
            <ul class="check-list" style="margin-top:1rem"><li>Name your own definition of success rather than inheriting one</li><li>Separate genuine ambition from borrowed expectation</li><li>Leave with a written statement of direction you can revisit</li><li>Practise saying what you want in front of people who will ask why</li></ul>
    ...
    <section class="section section-cream">
      <div class="container container-narrow" style="text-align:center">
        ...
        <p class="highlight" style="border-left:0;border-top:3px solid var(--gold);padding:1.25rem 0 0">Students and young professionals who feel capable but undirected, and anyone about to make a decision about study, work or leadership.</p>
      </div>
    </section>
        ...
        <div class="cta-banner reveal">
          <div class="cta-inner">
            <div>
              ...
              <h2>Ready to work on purpose?</h2>
